...
public class JDBCTestModule
{
    ...
    {
        Map<Integer, Object> actualParameterMap = verifyAndGetParametersForSQL(sql, indexOfParameterSet);
     ...
     * @throws VerifyFailedException if verification fails
     */
    public void verifySQLStatementParameter(String sql, int indexOfParameterSet, Map<Object, Object> parameterMap)
    {
        verifySQLStatementParameterNumber(sql, indexOfParameterSet, parameterMap.size());
        Map<Object, Object> actualParameterMap = verifyAndGetParametersForSQL(sql, indexOfParameterSet);
        Iterator<Object> keys = parameterMap.keySet().iterator();
        while(keys.hasNext())
        {
    ...
    public void verifyAllResultSetsClosed()
    {
        ...
        {
            MockResultSet[] resultSets = allResultSets.get(ii);
    ...
    {
        return ((MockPreparedStatement)statement).getParameterMap().containsKey(indexOfParameter);
    }
    ...
    {
        return ((MockCallableStatement)statement).getParameterMap().containsKey(indexOfParameter);
    }
