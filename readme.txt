...
without overhead. It is not meant for workflow tests or coarse grained 
action tests. If you want to do that or if you want to test the definitions
in the struts-config.xml file you can use StrutsTestCase 
...
in the de.mockrunner.example and de.mockrunner.example.test packages.
