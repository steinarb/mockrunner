...
class MockJspWriterTest
{
    ...
    {
        try (MockJspWriter writer = new MockJspWriter()) {
            writer.print("test1");
            writer.clear();
            writer.print("test2");
            writer.clearBuffer();
    ...
    void testWithProvidedWriter() throws Exception
    {
        ...
        try (MockJspWriter writer = new MockJspWriter(providedWriter)) {
            writer.print("test1");
            try
            {
                writer.clear();
    ...
    void testWithProvidedResponse() throws Exception
    {
        ...
        try (MockJspWriter writer = new MockJspWriter(response)) {
            writer.print("test1");
