...
public class MappedRecordInteractionTest extends TestCase
{
    ...
    public void testCanHandle()
    {
        ...
        expectedRequestMap.put("key1", 5);
        expectedRequestMap.put("key2", 6);
        expectedRequestMap.put("key3", 7);
    ...
    public void testExecuteReturnsRecord() throws Exception
    {
        ...
        responseMap.put(1, "value1");
        responseMap.put(2, "value2");
        responseMap.put(3, "value3");
        ...
        responseMap.put(2, "value2");
        responseMap.put(3, "value3");
        responseMap.put(4, "value4");
        responseMap.put(5, "value5");
