...
import org.codehaus.activemq.filter.mockrunner.ArithmeticExpression;
import org.codehaus.activemq.filter.mockrunner.BooleanExpression;
import org.codehaus.activemq.filter.mockrunner.ComparisonExpression;
import org.codehaus.activemq.filter.mockrunner.ConstantExpression;
...
import org.codehaus.activemq.filter.mockrunner.UnaryExpression;
...
public class SelectorParser implements SelectorParserConstants {
    ...
    public Filter parse(String sql) throws InvalidSelectorException {
        ...
        try {
            ...
            throw (InvalidSelectorException) new InvalidSelectorException(e.getMessage());
        }
...
// ----------------------------------------------------------------------------
    final public Filter JmsSelector() throws ParseException {
        ...
        {
            if (true) {
                return new ExpressionFilter(asBooleanExpression(left));
            }
        }
